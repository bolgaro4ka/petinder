...
<template>
    <div class="burger__wrapper" v-if="props.isOpen">
        ...
        <div class="burger__info">
            <p>Версия: PROPOTYPE v.0.0.1</p>
            <p>By Bolgaro4ka 2026</p>
        </div>
